...
// gettype()
    ...
    try {
        ...
        $obj->Send['OrderResultURL']         = "https://tibamef2e.com/tfd103/g1/TFD103-G1/src/php/member/deposit.php";

        // $obj->Send['OrderResultURL']         = "http://localhost/tfd103-g1/src/php/member/deposit.php";
        
        $obj->Send['ClientBackURL']         = "https://tibamef2e.com/tfd103/g1/TFD103-G1/src/html/deposit.html";
        $obj->Send['MerchantTradeNo']   = $MerchantTradeNo;                          //訂單編號
        $obj->Send['MerchantTradeDate'] = date('Y/m/d H:i:s');                       //交易時間
        $obj->Send['TotalAmount']       = $total;                                      //交易金額
        $obj->Send['TradeDesc']         = "test" ;
        $obj->Send['StoreID']         =  $Name;                          //交易描述
        $obj->Send['ChoosePayment']     = ECPay_PaymentMethod::Credit ;              //付款方式:Credit
        $obj->Send['IgnorePayment']     = ECPay_PaymentMethod::GooglePay ;           //不使用付款方式:GooglePay

        //訂單的商品資料
        array_push($obj->Send['Items'], array('Name' => "儲值卡", 'Price' => (int)"$total",
                   'Currency' => "E", 'Quantity' => (int) "1", 'URL' => "dedwed"));
