...
$(function () {
  var divWidth = $('#sliderBoard').width();
  ...
  $('#contentButton li:nth-child(1)').addClass('clickMe'); //設定target畫面切換
  ...
  function resizeWindow() {
    ...
    var index = $("#contentButton li.clickMe").index();
